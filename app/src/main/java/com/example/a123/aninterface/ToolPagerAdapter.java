...
public class ToolPagerAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        throw new IllegalArgumentException("Не переданный результат: " + position);
    }
    ...
    public long getItemId(int position) {
        ...
        throw new IllegalArgumentException("Неверная позиция (" + position + ") или ToolType (" + mToolType + ")");
    }
}